...
**Out of Pass C.A** (Pass C.B): full detail page · onboarding checklist UI (tables already exist + seeded) · Convert-to-driver action · Archive view of past candidates.
